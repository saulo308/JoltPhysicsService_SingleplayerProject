...
cmake -S . -B $BUILD_DIR -G "Unix Makefiles" -DCMAKE_PREFIX_PATH=$MY_INSTALL_DIR -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DCMAKE_CXX_STANDARD=17 -DCMAKE_CXX_COMPILER=$COMPILER "${@}"
